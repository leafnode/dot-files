...
" $Id: cvscommand.vim,v 1.1 2003/08/25 23:35:52 leon Exp $
"
" Vim plugin to assist in working with CVS-controlled files.
"
" Last Change:   $Date: 2003/08/25 23:35:52 $
...
function! s:CVSGotoOriginal(...)
  ...
  if origBuffNR > 0
    if a:0 == 1
      if a:1 == "!"
        bufdo if exists("b:CVSOrigBuffNR") && b:CVSOrigBuffNR == origBuffNR | bw | endif
      endif
    endif
