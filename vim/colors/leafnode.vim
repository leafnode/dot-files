...
" vim: tw=0 ts=4 sw=4
" Vim color file, derived from colorscheme 'nightwish'
" Maintainer:	Leszek Krupinski <leszek in php dot net>
" Version:      1.0
" URL:          http://www.leon.w-wa.pl/
...
hi Normal		ctermbg=NONE  ctermfg=lightgreen guibg=NONE	guifg=#a0a0ff
hi Cursor										  guifg=bg	guibg=Green
hi String       term=underline cterm=bold ctermfg=red       guifg=#ffa0a0
hi Repeat       term=underline ctermfg=Blue    guifg=Red
